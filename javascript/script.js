...
function updateTimer() {
  const targetDate = new Date("January 17, 2025 13:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543884148666'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543884148666'; // Número para el primer botón
